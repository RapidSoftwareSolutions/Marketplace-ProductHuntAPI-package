...
$app->post('/api/ProductHuntAPI/getTopics', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . '/topics';
    ...
    if(!empty($post_data['args']['searchTrending'])) {
        $query['search[trending]'] = $post_data['args']['searchTrending'];
    }
    if(!empty($post_data['args']['searchFollowerId'])) {
        $query['search[follower_id]'] = $post_data['args']['searchFollowerId'];
    }
