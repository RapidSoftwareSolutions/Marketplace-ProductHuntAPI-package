...
$app->post('/api/ProductHuntAPI/getNotifications', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . '/notifications';
    ...
    if(!empty($post_data['args']['searchType'])) {
        $query['search[type]'] = $post_data['args']['searchType'];
    }
